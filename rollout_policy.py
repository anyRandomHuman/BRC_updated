...
def parse_args():
    ...
    parser.add_argument("--output", type=str, default="rollouts/policy.mp4",
    ...
    parser.add_argument("--mujoco-gl", type=str, default=None,
                        help="Optional MUJOCO_GL value, e.g. egl, osmesa, or glfw.")
...
def default_checkpoint_path(cfg):
    ...
    return Path("checkpoints") / save_path / str(cfg.seed)
...
def main():
    ...
    checkpoint = Path(args.checkpoint) if args.checkpoint else default_checkpoint_path(cfg)
